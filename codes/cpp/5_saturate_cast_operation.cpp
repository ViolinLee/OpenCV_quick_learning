...
int main(int artc, char** argv) {
	Mat src1 = imread("E:/CV/OpenCV_zhaizhigang/code_005/LinuxLogo.jpg");
	Mat src2 = imread("E:/CV/OpenCV_zhaizhigang/code_005/WindowsLogo.jpg");
	...
	for (int row = 0; row < height; row++) {
		for (int col = 0; col < width; col++) {
				...
				result.at<Vec3b>(row, col)[0] = saturate_cast<uchar>(b1 + b2); //saturate_cast + ½á¹ûÍ¬ add
