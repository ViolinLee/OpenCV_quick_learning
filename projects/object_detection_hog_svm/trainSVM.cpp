...
int main()
{
	cv::Mat image = imread("E:/CV/OpenCV_quick_learning/projects/object_detection_hog_svm/girl.jpg", cv::IMREAD_GRAYSCALE);
	...
	cv::imwrite("E:/CV/OpenCV_quick_learning/projects/object_detection_hog_svm/girl_hog.jpg", hogImage);
	...
	cv::imwrite("E:/CV/OpenCV_quick_learning/projects/object_detection_hog_svm/Positive_samples.jpg", posSamples);
	...
	cv::imwrite("E:/CV/OpenCV_quick_learning/projects/object_detection_hog_svm/Negative_samples.jpg", negSamples);
